package com.isaolmez.kafkaguide.vanilla.consumer.lesson5;
...
public class SimpleConsumer {
    ...
    public void consumeWithMaxPollIntervalMs() {
        ...
        kafkaProperties.setProperty("max.poll.interval.ms", "1000");
        ...
        try (KafkaConsumer<String, String> kafkaConsumer = new KafkaConsumer<>(kafkaProperties)) {
            ...
            while (true) {
                ...
                for (final ConsumerRecord<String, String> consumerRecord : consumerRecords) {
                    ...
                    log.info("Long processing starts...");
                    sleep();
                }
            }
        }
