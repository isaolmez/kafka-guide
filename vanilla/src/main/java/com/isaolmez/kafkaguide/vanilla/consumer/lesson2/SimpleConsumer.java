...
public class SimpleConsumer {
    ...
    public void consumeWithFetchMinBytes() {
        ...
        kafkaProperties.setProperty("fetch.min.bytes", "1000");
        kafkaProperties.setProperty("fetch.max.bytes", "2000");
        kafkaProperties.setProperty("fetch.max.wait.ms", "1000");
