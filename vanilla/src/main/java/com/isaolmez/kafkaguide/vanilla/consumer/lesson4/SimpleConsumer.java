package com.isaolmez.kafkaguide.vanilla.consumer.lesson4;
...
public class SimpleConsumer {
    ...
    public void consumeWithConfiguredHeartBeat() {
        ...
        kafkaProperties.setProperty("session.timeout.ms", "10000");
        kafkaProperties.setProperty("heartbeat.interval.ms", "200");
